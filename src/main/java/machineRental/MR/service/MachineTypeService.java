...
public class MachineTypeService {
    ...
    public MachineType create(MachineType machineType, BindingResult bindingResult) {
        validateMachineType(machineType.getMachineType(), null, bindingResult);
    ...
    public MachineType update(Integer id, MachineType machineType, BindingResult bindingResult) {
        ...
        validateMachineType(machineType.getMachineType(), dbMachineType.get().getMachineType(), bindingResult);

        machineType.setId(id);
        return machineTypeRepository.save(machineType);
    }

    private void validateMachineType(String type, String currentType, BindingResult bindingResult) {
